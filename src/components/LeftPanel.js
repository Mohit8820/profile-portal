...
import mohitIco from "../assets/images/MohitIcon.webp";
...
const LeftPanel = (props) => {
  ...
  return (
    <div className={`left-panel ${expand ? "expanded" : ""}`}>
      <div className="my-ico">
        <img src={mohitIco} alt="ico" />
      </div>{" "}
      <button onClick={expandPanel} className="expand-panel-button">
        {expand ? (
          <svg
